...
class TestHealRoom(TestCase):
    ...
    def test_heal_room_already_healthy(self):
    ...
    def test_heal_room_is_this_technically_damage(self):
    ...
    def test_heal_room_no_current_hp_in_player(self):
        with self.assertRaises(KeyError):
            test_player = {"Max HP": 20, "What is health?": 3}
            heal_room(test_player)

    def test_heal_room_no_integer_in_current_hp(self):
        with self.assertRaises(TypeError):
            test_player = {"Max HP": 20, "Current HP": 7.2}
            heal_room(test_player)

    def test_heal_room_no_max_hp_in_player(self):
        with self.assertRaises(KeyError):
            test_player = {"What is health?": 20, "Current HP": 3}
            heal_room(test_player)

    def test_heal_room_no_integer_in_max_hp(self):
        with self.assertRaises(TypeError):
