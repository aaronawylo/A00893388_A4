...
class TestMakeCharacter(TestCase):
    def test_make_character_values_equal(self):
        ...
        expected = {"X-coordinate": 0, "Y-coordinate": 0, "Max HP": 20, "Current HP": 20, "atk": 2, "def": 2, "level":
                    1, "exp": 0, "potions": 3, "Battle Actions": ["Attack", "Defend", "Use Potion"]}
    ...
    def test_make_character_exp_value(self):
        actual = make_character()
        expected = {"X-coordinate": 0, "Y-coordinate": 0, "Max HP": 20, "Current HP": 20, "atk": 2, "def": 2, "level":
                    1, "exp": 0, "potions": 3, "Battle Actions": ["Attack", "Defend", "Use Potion"]}
